...
namespace AppFront.Pages.CategoryViews
{
    public partial class EditCategoryPage
    {
        ...
        Form<LessonCategory> form = new Form<LessonCategory>();

        public LessonCategory _model = new LessonCategory();
        ...
        protected override void OnInitialized()
        {
            ...
            _model = new LessonCategory()
            {
                //File = new FileEntity()
                Slug = Guid.NewGuid().ToString(),
            };
            form = new Form<LessonCategory>();
            base.OnInitialized();
        ...
        public async Task OnFinish(EditContext editContext)
        {
            ...
            if (a is not null && _addNewItem)
            {
                ...
                NavigationManager.NavigateTo($"/Category/Edit/{a.Id}", replace: true);
                _addNewItem = false;
                _ = Load();
            }
            StateHasChanged();
